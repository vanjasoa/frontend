            ...
            <div class="flex mt-8">
                ...
                <div class="flex-initial w-20 h-20 ">
                    <button @click="emit('quit')">
                        <svg class="bg-black rounded-lg" width="50" height="50" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div>  
            ...
            <ul v-for="commande in props.historique">
                <li class="border-2 border-black p-2 rounded-md m-2">
                    ...
                    <span v-if="commande.status == 'save'" class="inline-flex items-center bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
